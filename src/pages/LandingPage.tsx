                    ...
                    <section className="py-20 bg-gray-50">
                        <div className="max-w-6xl mx-auto px-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                                {[
                                    { name: "Rahul Sharma", role: "MSME Owner", text: "Kaushal Network helped us expand our business reach significantly." },
                                    { name: "Priya Patel", role: "Service Provider", text: "Found numerous clients and partnerships through this platform." },
                                    { name: "Amit Kumar", role: "Corporate Partner", text: "The perfect platform to discover and connect with MSMEs." }
